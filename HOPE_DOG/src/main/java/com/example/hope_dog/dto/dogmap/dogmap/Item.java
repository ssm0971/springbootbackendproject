...
public class Item {
    ...
    private Long vetPersonCnt;    // 수의사 수
    private Long specsPersonCnt;   // 전문 인력 수
    private String careTel;          // 연락처
    private String dataStdDt;        // 데이터 기준일

    // 추가적인 필드 (필요시)
    private Long medicalCnt;      // 의료 수
    private Long breedCnt;        // 품종 수
    private Long quarabtineCnt;   // 격리 수
    private Long feedCnt;         // 먹이 수
    private Long transCarCnt;     // 이동차량 수
