...
function modifyCommentBtnClcik() {
  const commentBox1 = document.getElementById('protect-comment-buttonBox'); //수정/삭제버튼 div
  const commentBox2 = document.getElementById('protect-modifyInput');       //댓글수정하는div
  const commentBox3 = document.getElementById('protect-comment');           //이미입력된댓글
