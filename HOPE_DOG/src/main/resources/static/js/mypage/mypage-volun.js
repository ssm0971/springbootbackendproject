...
// 게시글로 이동
document.querySelectorAll('.mypage-volun-list').forEach(function(element) {
    element.addEventListener('click', function() {
        const volunRequestNo = element.querySelector('.volunRequestNo').innerText;
        window.location.href = '/mypage/updateVolunRequest?volunRequestNo=' + volunRequestNo; // 상세 페이지로 이동
    });
});

document.addEventListener("DOMContentLoaded", function() {
    const items = $('.mypage-volun-list ul'); // 게시글 항목들을 li로 선택
